...
Plans:
- [ ] 03-01: Implement OAuth callback server, token refresh, and account creation services
- [ ] 03-02: Implement usage adapters, retry/refresh handling, and result normalization
- [ ] 03-03: Build add-account OAuth flow and usage presentation in the frontend
